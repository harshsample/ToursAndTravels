<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="email.aspx.cs" Inherits="Project.Admin.email" %>
		 ...
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign Up</div>
		    <form runat="server">
			  ...
			  <label for="exampleInputName" class="sr-only">EMAIL ID</label>
			   <div class="position-relative has-icon-right">
				  <%--<input type="text" id="exampleInputName" class="form-control input-shadow" placeholder="Enter Your Name">--%>
				   <asp:TextBox ID="txtemail" runat="server" class="form-control input-shadow" placeholder="Enter Your EMAIL"></asp:TextBox>
			 ...
			 <%--<button type="button" class="btn btn-primary btn-block waves-effect waves-light">Sign Up</button>--%>
				<asp:Button ID="btnpass" runat="server" Text="RETRY PASSWORD" class="btn btn-primary btn-block waves-effect waves-light" />
