<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_signin.aspx.cs" Inherits="Project.Admin.admin_signin" %>
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign In</div>
			  ...
			  <label for="exampleInputUsername" class="sr-only">Email</label>
			   <div class="position-relative has-icon-right">
				 <%-- <input type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Username">--%>
				   ...
				   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter Email.." ControlToValidate="txtemail" ForeColor="#FF3300"></asp:RequiredFieldValidator>
			  ...
			  <label for="exampleInputPassword" class="sr-only">Password</label>
			   <div class="position-relative has-icon-right">
				 <%-- <input type="password" id="exampleInputPassword" class="form-control input-shadow" placeholder="Enter Password">--%>
				   ...
				   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter Password.." ControlToValidate="txtpass" ForeColor="#FF3300"></asp:RequiredFieldValidator>
				  <div class="form-control-position">
					  <i class="icon-lock"></i>
				  </div>
			   </div>
			...
			<div class="form-row">
			 ...
			 <div class="form-group col-6 text-right">
			  <a href="email.aspx">Reset Password</a>
			 </div>
			</div>
			<%-- <button type="button" class="btn btn-primary btn-block">Sign In</button>--%>
				<asp:Button ID="btn_admin_signin" runat="server" Text="SignIn"  class="btn btn-primary btn-block" OnClick="btn_admin_signin_Click" />
