<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="tourinclusion.aspx.cs" Inherits="Project.Admin.WebForm19" %>
           ...
           <hr>
            <form runat="server">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddltourinclusion" required="this field is required" runat="server" class="form-control form-control-rounded" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="placename" DataValueField="tdid"></asp:DropDownList>
