<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="cutomizeTourBooking.aspx.cs" Inherits="Project.User.WebForm23" %>
                    ...
                    <form class="row g-3" runat="server">
                       ...
                       <hr />
                        ...
                        <div class="col-12">
                            ...
                            <asp:Button ID="btn_booknow" class="booking-bt btn btn-primary" runat="server" Text="Proceed For Payment " OnClick="btn_booknow_Click1" />
                        </div>
                    </form>
                </div>
            </div>
