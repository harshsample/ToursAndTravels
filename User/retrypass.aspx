<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="retrypass.aspx.cs" Inherits="Project.User.WebForm12" %>
                        ...
                        <form runat="server">
                           <div class="row">
                                ...
                                <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                    <%--<input class="floating-input form-control" type="email" >--%>
                                     <asp:TextBox ID="txtnewpass" required="this field is required" runat="server" class="floating-input form-control " placeholder=" " TextMode="Password"></asp:TextBox>
                                ...
                                <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                    <%--<input class="floating-input form-control" type="email" >--%>
                                     <asp:TextBox ID="txtconpass" required="this field is required" runat="server" class="floating-input form-control " placeholder=" " TextMode="Password"></asp:TextBox>
                                    <label>Confrim Password</label>
                                 </div>
                              </div>
                           </div>
                           <%--<button type="submit" class="btn btn-primary">Reset</button>--%>
                            <asp:Button ID="btn_send" runat="server" Text="Confrim"  class="btn btn-primary" OnClick="btn_send_Click"/>
                        </form>
                     </div>
